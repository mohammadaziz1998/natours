...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9oYW1hZGF6ZXoxMjM0IiwiYSI6ImNscnV4azF3ZDBsbWgybHAxeDVyM2w5ZHAifQ.9TEisOJwP2cXaF4e1ns9ww';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/mohamadazez1234/clrvre2d9012u01pb2xm74fk1',
    // style URL
    scrollZoom: false
...
///
///
var stripe = Stripe('pk_test_51OfeOWK37MSqqPM1OUXoVfMfY206hlypyf6FnPpvSq5FyCklCMigLniBWKUP4wBZMR4jk9rYUfio2DIgnsVs99Rx002E16tWGy');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var password, passwordConfirm, passwordCurrent;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
